...
public class HomeController {
	...
	public ModelAndView ex1(ModelAndView mv, String name, Double age) {
		System.out.println("예제1 : 화면에서 전달받은 이름 :  " + name);
		System.out.println("예제1 : 화면에서 전달받은 나이 :  " + age);
		mv.setViewName("/main/ex1");
		return mv;
	}
	@RequestMapping(value = "/ex2")
	public ModelAndView ex2(ModelAndView mv, String name, Double age) {
		System.out.println("예제2 : 화면에서 전달받은 이름 :  " + name);
		System.out.println("예제2 : 화면에서 전달받은 나이 :  " + age);
		mv.setViewName("/main/ex2");
		return mv;
	}
	@RequestMapping(value = "/ex3")
	public ModelAndView ex3(ModelAndView mv, String name, Double age) {
	...
	public ModelAndView exNameAge3(ModelAndView mv, @PathVariable("name")String name,
		...
		System.out.println("예제3 : 화면에서 전달받은 이름 :  " + name);
		System.out.println("예제3 : 화면에서 전달받은 나이 :  " + age);
		mv.setViewName("/main/ex3");
		return mv;
	}
