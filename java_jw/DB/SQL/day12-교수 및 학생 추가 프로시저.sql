...
-- 123, '기계 공학부', 'KH교육원 1관 1층', '02-123-4568'
-- 135, '전자 공학부', ' KH교욱원 2관 3층', '02-123-1234'

insert into department 
	values(160, '컴퓨터 공학부', 'KH교육원 1관 1층', '02-123-456',null),
    (123, '기계 공학부', 'KH교육원 1관 1층', '02-123-4568',null),
    (135, '전자 공학부', ' KH교욱원 2관 3층', '02-123-1234',null);
    
-- 컴퓨터 공학부에 2022년 홍길동 교수님이 오셨다. 이 때 홍길동 교수님의 정보를 추가하는 작업을 해보세요.
-- (이 때, 교수님 학번은 2022160001이 할당 되어야 함 - >프로시저). 
