...
import example_phonebook.PhoneBook;
...
public class AttendanceMain {
	...
	public static void main(String[] args) {
		 ...
		 * -이름과 생년월일로 검색해서 삭제
		 * 4. 학생 출결 확인
		 * - 이름과 생년월일로 검색해서 해당학생의 모든 출결을 확인
		 * -2022-11-22 : O
		 * 5. 출석 확인
		 * -날짜 입력 : 2022-11-22
		 * -(출석 : 0, 지각 : /, 조퇴 : \, 결석 : X)
	...
	private static void managementStudents(ArrayList<Student> stds) {
		...
		switch(subMenu) {
		case 1:
			addStudent(stds); break;
		case 2:
			updateStudent(stds); break;
		case 3:
			deleteStudent(stds); break;
		case 4 :
			printStr("취소했습니다."); break;
		default:
